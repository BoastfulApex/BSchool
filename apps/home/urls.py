...
urlpatterns = [
    ...
    path('owners/', views.course_owners, name='owners'),
    path('owners/<int:pk>', views.owners_detail, name='owners_detail'),
    path('owners_create/', views.owners_create, name='owners_create'),
    path('owners_delete/<int:pk>', views.ownerDelete.as_view(), name='owners_delete'),
    ...
    path('photos_delete/<int:pk>', views.PhotoDelete.as_view(), name='photos_delete'),
    path('videos/', views.video_gallery, name='videos'),
    path('videos/<int:pk>', views.videos_detail, name='videos_detail'),
    path('videos_create/', views.videos_create, name='videos_create'),
    path('videos_delete/<int:pk>', views.VideoDelete.as_view(), name='videos_delete'),
